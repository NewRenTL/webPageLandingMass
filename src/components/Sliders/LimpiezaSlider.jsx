...
const LimpiezaSlider = () => {
  const LimpiezaItems = dataCategories.filter(
    (item) => item.categorie === "Limpieza"
  );
  var settings = {
    dots: true,
    infinite: true,
