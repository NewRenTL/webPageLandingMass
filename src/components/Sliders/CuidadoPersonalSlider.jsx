...
const Cuidado_PersonalSlider = () => {
  const Cuidado_PersonalItems = dataCategories.filter(
    (item) => item.categorie === "Cuidado_personal"
  );
  var settings = {
    dots: true,
    infinite: true,
  ...
  console.log(Cuidado_PersonalItems);
  return (
    <Slider
      {...settings}
    ...
    >
      {Cuidado_PersonalItems.map((item, index) => (
        <div
          key={index}
...
export default Cuidado_PersonalSlider;
