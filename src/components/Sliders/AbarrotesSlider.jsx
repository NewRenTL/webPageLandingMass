...
const AbarrotesSlider = () => {
  const AbarrotesItems = dataCategories.filter(
    (item) => item.categorie === "Abarrotes"
  );
  var settings = {
    dots: true,
    infinite: true,
...
export default AbarrotesSlider;
